...
<!------ Script And Style ----->
 ...
 <script type="text/javascript" src="<?php echo $vpath?>myScript/addNewPatients.js"></script>
...
<tr>
<td>Patients ID:&nbsp;<span class="label label-success">Default</span></td>
</tr>
<tr>
<td>
<script type="text/javascript">
...
function ()
{
$('#load_doc_id').load('getPID.php').fadeIn("slow");
...
<tr>
<td  >House No., St. Barangay&nbsp;<span class="label label-success">Optional</span></td>
...
<a href="javascript:void(0);" class="btn btn-medium btn-primary btn-large" onClick="addNewPatients();" style="float:left;">Save</a>
</td></tr>
</table>
