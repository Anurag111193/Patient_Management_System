 ...
 $(document).ready(function(){
     ...
     $('.search').keyup(function(){
         ...
         if(searchbox == true){
             $.ajax({
                 type: "POST",
                 url: "ajaxFiles/SearchPatients.php",
                 data: dataString,
                 cache: false,
                 success: function(h){
                     $('#display').html(h).hide();
        ...
        $(".delbutton").click(function(){
            ...
            if(confirm("Are you sure you want to delete this Record?")){
                $.ajax({
                    type: "POST",
                    data: info,
                    url : "ajaxFiles/deletePatients.php",
...
<div class="div_view">
    <div id="display">
        <table border="1" bordercolor="#999999" style="width:905px; margin:auto;">
            ...
            $getDoctors = "SELECT `p_id`,`fname`,`lname`,`age`,`city`,`mi` FROM ".$prev."patient ORDER BY `p_id` ASC";
            ...
            <tr class="hr" bgcolor="" height="37">
                <td align="left" width="150"><?php echo $docRecords['p_id']?></td>
                ...
                <td align="center" style="width:99px;">
                    <a href="backup.php?d_id=<?php echo $docRecords['p_id'];?>&pname=<?php echo $docRecords['fname'];?>" class="btn"><i class="icon-plus icon-black"></i>&nbsp;Backup</a>
                </td>
                <td align="center" width="75">
                    <a href="?view_patients&details&d_id=<?php  echo $docRecords['p_id'];?>&edit_doc_record" class="btn"><i class="icon-edit icon-black"></i>&nbsp;Edit</a>
                </td>
                <td align="center" width="70">
                     <a href="?view_patients&details&d_id=<?php echo $docRecords['p_id'];?>" class="btn btn-info"><i class="icon-file icon-white"></i>&nbsp;Info</a>
                </td>
                <td align="center" width="90">
                    <a href="javascript:void(0);" id="<?php echo $docRecords['p_id']; ?>" class="delbutton btn btn-danger" title="Click To Delete"><i class="icon-trash icon-white"></i>&nbsp;Delete</a>
                </td>
            </tr>
           <?php endwhile ?>
           <?php else:?>
...
<script>
    ...
    $(document).ready(function(){
        $('#close').click(function(){
            ...
            windows.location = "?view_patients";
        })
    })
...
<div class="container" id="success" style=" z-index:10000; position:absolute;margin-top:-517px;display:none;">
    ...
    if(isset($_GET['d_id'])){
        $doc_id = $_GET['d_id'];
        $modalDoctorInfo = "SELECT *FROM ".$prev."patient WHERE `p_id` = '$doc_id' ORDER BY `p_id` ASC";
    ...
    <div class="divpop">
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
                     ...
                     <div class="nav-collapse">
                         <ul class="nav">
                             <li><a href="?view_patients&details&d_id=<?php  echo $_GET['d_id'];?>"><i class="icon-home icon-black"></i> Profile</a></li>
                             <li>&nbsp;</li>
                             <li><a href="?view_patients&details&d_id=<?php  echo $_GET['d_id'];?>&view_doc_record"><i class="icon-list icon-black"></i>&nbsp;Patients All Records</a></li>
                             <li><a href="?view_patients&details&d_id=<?php  echo $_GET['d_id'];?>&edit_doc_record"><i class="icon-edit icon-black"></i>&nbsp;Edit Baisc Information</a></li>
							 <li><a href="?view_patients&details&d_id=<?php  echo $_GET['d_id'];?>&add_doc_record"><i class="icon-edit icon-black"></i>&nbsp;Add Records</a></li>
                         </ul>
        ...
        if(isset($_GET['view_doc_record'])){
            include('view_pat_record.php'); //Include View Docrecord
        }elseif(isset($_GET['edit_doc_record'])){
            include('edit_pat_record.php'); //Edit Doc Record Include
        }
		elseif(isset($_GET['add_doc_record'])){
            include('add_pat_record.php'); //Edit Doc Record Include
        }
		else{
        ...
        <table border="0" style="font-size:15px; height:300px; width:400px; margin-left:20px; margin-bottom:20px;">
            <tr>
                <tr><td>Patient ID<td>:</td></td><td><?php echo $modalDoctorInfoShow['p_id'];?></td></tr>
        ...
        <div class="modal-footer">
            <table style="">
                <td><td><a href="?view_patients" class="btn"><i class="icon-remove icon-black"></i>&nbsp;Close</a></td>
            </table>
        </div>
