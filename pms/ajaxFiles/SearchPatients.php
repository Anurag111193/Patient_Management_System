...
if(isset($_POST)){
    ...
    $searchQuery = "SELECT * FROM ".$prev."patient WHERE `fname` LIKE '$q%' OR `lname` LIKE '$q%' OR `p_id` LIKE '$q%'"; //search query
...
<table border="1" bordercolor="#999999" style="width:905px; margin:auto;">
    ...
    while($getSearchResult = mysql_fetch_array($searchQueryResult)){
        ...
        $items ++;
        $d_id = $getSearchResult['p_id']; // Get Doctor ID
    ...
    <tr class="hr" bgcolor="" height="37">
        ...
        <td align="left" style="width:387px;"><?php echo $stat.ucwords($findFullName)?></td>
         <td align="center" style="width:99px;">
                    <a href="?add_app_form&d_id=<?php echo $docRecords['p_id'];?>" class="btn"><i class="icon-plus icon-black"></i>&nbsp;Add App</a>
         </td>
        <td align="center" width="75">
            <a href="?view_doctors&details&d_id=<?php  echo $docRecords['p_id'];?>&edit_doc_record" class="btn"><i class="icon-edit icon-black"></i>&nbsp;Edit</a>
        </td>
        <td align="center" width="70">
             <a href="?view_doctors&details&d_id=<?php echo $docRecords['p_id'];?>" class="btn btn-info"><i class="icon-file icon-white"></i>&nbsp;Info</a>
        </td>
        <td align="center" width="90">
            <a href="#" id="<?php echo $rs['p_id']; ?>" class="delbutton btn btn-danger" title="Click To Delete"><i class="icon-trash icon-white"></i>&nbsp;Delete</a>
        </td>
